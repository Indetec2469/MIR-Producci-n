...
var API_FICHA = "/compras/reportes/reportesurtidomateriales/";
...
var verReporte = function (event) {
    ...
    //Abrimos el reporte
    window.open("/compras/requisiciones/requisicionporsurtir/rptSurtidoSolicitud/?requisicionId=" + data.RequisicionMaterialId + "&agrupadorId=" + data.InventarioMovtoAgrupadorId);
}
