...
BEGIN
		...
		FROM ARtblCortesia AS cortesia
			 ...
			 LEFT JOIN ARtblAlmacenProducto AS ap ON cortesia.AlmacenId = ap.AlmacenId AND detalle.ProductoId = ap.ProductoId AND detalle.CuentaPresupuestalEgrId = ap.CuentaPresupuestalId
		WHERE cortesia.CortesiaId = @CortesiaId
			  AND ap.AlmacenProductoId IS NULL
